 ...
 * @subpackage GoGrid Theme functions
 * @since      GoGrid 1.0.2 
 */
...
<body <?php body_class(); ?>>
	<?php wp_body_open(); ?>
		<a class="skip-link screen-reader-text" href="#main">
			<?php esc_attr_e( 'Skip to content', 'gogrid' ); ?>
		</a>
	<div class="site">
		...
		<div class="masthead">
			...
			if ( ! empty( $header_image ) ) : ?>
				...
				<figure class="header-banner">
					...
					<a href="<?php echo esc_url( home_url() ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><img id="header-img" src="<?php header_image(); ?>" width="<?php echo esc_attr( get_custom_header()->width ); ?>" 
						...
						if( has_custom_logo() ) : ?>
							...
							<div class="site-logo-container">
								...
								<div class="gogrid-logo-container site-logo">
									<a href="<?php 
										echo esc_url( home_url( '/' ) ); ?>" rel="bookmark">
										<?php 
										echo wp_kses_post( force_balance_tags( gogrid_theme_custom_logo() ) ); ?>
									</a>
								</div>
							</div>
						<?php 
